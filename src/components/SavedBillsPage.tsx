...
const SavedBillsPage: React.FC = () => {
  ...
  const handleClearAll = () => {
    if (window.confirm('Are you sure you want to remove all saved bills? This action cannot be undone.')) {
      clearAllBookmarks();
    }
  };
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800">
        <div className="container mx-auto px-4 py-8">
          <div className="text-center py-16">
            ...
            <h2 className="text-2xl font-bold text-slate-300 mb-4">No Saved Bills Yet</h2>
            <p className="text-slate-400 mb-8 max-w-md mx-auto">
              Start bookmarking bills that interest you to keep track of important legislation.
            </p>
            <Button 
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-slate-400">
                {bookmarkCount} bill{bookmarkCount !== 1 ? 's' : ''} saved for later review
              </p>
            </div>
            <Button
