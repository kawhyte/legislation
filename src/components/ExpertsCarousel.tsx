...
const lawImpactData: LawImpact[] = [
  {
    ...
    description: "Laws ensure fair treatment and protect your fundamental rights, creating a just society for everyone.",
    image: "/justice.svg",
  ...
  },
  {
    ...
    description: "From minimum wage to business regulations, laws create the economic environment for jobs and innovation to flourish.",
    image: "/forms.svg", 
  ...
  },
  {
    id: 3,
    title: "Health & Safety",
    description: "Food safety standards, healthcare regulations, and workplace protections keep you and your family safe every day.",
    image: "/hands.svg",
  ...
  },
  {
    ...
    description: "Educational policies and student aid programs shape opportunities for learning and personal growth throughout life.",
    image: "/justice.svg",
  ...
  },
  {
    ...
    description: "Clean air and water standards protect the environment we all depend on for health and prosperity.",
    image: "/hands.svg",
  ...
  },
  {
    ...
    description: "Data protection laws and digital rights regulations safeguard your personal information in our connected world.",
    image: "/forms.svg",
    backgroundColor: "bg-wellness-purple",
  }
];
